...
import laravelImg from '../assets/laravel-framework.png';
    ...
    createShader() {
      ...
      `,
        ...
        void main() {
          ...
          // Discard transparent pixels to remove background
...
class App {
    ...
    onResize() {
        this.screen = {
            ...
            height: this.customHeight || this.container.clientHeight,
        };
